...
}),l.initHelpDialog=l.waitAndRunKeyReq=l.runNextOnTabLoaded=l.runNextCmdBy=l.getRunNextCmdBy=l.runNextCmd=l.makeFallbackContext=l.wrapFallbackOptions=l.parseFallbackOptions=l.hasFallbackOptions=l.executeExternalCmd=l.executeShortcut=l.portSendFgCmd=l.sendFgCmd=l.onConfirmResponse=l.onBeforeConfirm=l.T=l.ne=l.executeCommand=l.fillOptionWithMask=l.overrideOption=l.overrideCmdOptions=l.concatOptions=l.copyCmdOptions=l.replaceCmdOptions=void 0
;let f,a,m,$=Math.abs,p=0,c=1;l.replaceCmdOptions=e=>{t.x=r.di(e)},l.copyCmdOptions=(e,l)=>{
...
l.overrideCmdOptions=(e,l,n)=>{let u=n||t.x;r.bi(r.di(e),u),l?delete e.$o:e.$o=u,n||(t.x=e)},l.overrideOption=(e,r,n)=>{
...
;if(1===l.length)e=a=l[0];else{if(""!==n)return h=l.length,"";e=""}}return m=1,d=e+"",d="$s"===$||"%s"===$?r.Sl(d):d,d
},h=1,b=0
;if(p?((e.includes(c="$c")||e.includes(c="%c"))&&(m=1,v=true),e=e.replace(new RegExp("\\$\\{([^}]*)}|\\$\\$"+(v?"|"+r.ul(c):"")+(_?"|"+r.ul($):""),"g"),(e,l)=>{
if(e===$)return g();if(e===c)return o+"";if(!l)return"$";m=1,b++;let n=false,i=u.Si.exec(l);i&&(l=l.slice(0,i.index)),
/^[sS]:/.test(l)&&(n="s"===l[0],l=l.slice(2));let s=u.Ci.exec(l)||u.Ii.exec(l)
;s&&(l="<"===s[0][0]?l.slice(0,s.index):l.slice(s[0].length))
;let f=s?t.vl.get("<"===s[0][0]?s[0].slice(1):s[0].slice(0,-1))||"":"__proto__"===l||"$"===l[0]?"":l?y[l]:g()
;return f="string"==typeof f?f:f&&"object"==typeof f?JSON.stringify(f):f+"",i&&(f=t.S(f,0,r.Xe(i[0].slice(1)))),
n?r.Sl(f):f})):_&&(g(),null!==d&&(e=e.replace($,()=>d))),1!==h)return{ok:0,result:h};if($&&"string"==typeof $){
let e=f||{};f||l.overrideCmdOptions(e),e.$masked=true,a&&delete e[a]}return{ok:m,value:d||"",result:e,useCount:v,
useDict:b}};let d=e=>{let l=f;if(f=null,l)if(a){let{We:t,Ge:n}=r.Je();l(e,n),t.then(g)}else l(e,t.o);return t.hn=null,
e?void 0:n.g()},v=e=>{l.executeCommand(e,1,t.Ce,t.O,t.$)};l.executeCommand=(e,u,s,m,p,c)=>{if(y(0),f)return f=null,
void(t.hn=null);let _,h=o.oi(e),b=e.fa
;if(h&&(_=h.$count)&&(u=u*_||1),1===(u=p||(u>=1e4?9999:u<=-1e4?-9999:0|u||1)));else if(1===b)u=1;else if(b>1&&(u>b||u<-b)){
if(null!=c)u=u<0?-1:1;else if(!(p||h&&true===h.confirmed))return t.Ce=s,t.x=null,t.O=m,t.$=u,t.hn=null,
...
i.showHUD(`Has run sequential commands for ${r} times`),void(t.hn=null);let n=l.makeFallbackContext(c.c,1,c.u)
;if(h&&((38===e.ui||n.t)&&e.ni||l.hasFallbackOptions(h))){let t={};l.overrideCmdOptions(t,false,h),t.$retry=-r,t.$f=n,
n.t&&e.ni&&!h.$else&&(t.$else="showTip"),h=t}}if(e.ni);else{if(null!=m){
let{ui:r}=e,n=4620>>r&1||4===r&&!!h&&false===h.keepHover;return t.O=m,t.hn=null,void l.portSendFgCmd(m,r,n,h,u)}{
let l=e.ui,t=0;if(18===l?n.we.goBack&&(t=23):11===l&&(t=14),!t)return;e=o.la(e.ra,h,[t,1,e.fa])}}let{ui:T}=e,j=t.M[T]
;if(a=e.ga,null===a&&(a=e.ga=null!=h&&l.hasFallbackOptions(h)),t.Ce=s,t.x=h||(e.ba=r.i()),t.O=m,t.$=u,u=t.y[T],
null==m&&T<13&&T>2);else if(u<1){if(a){let{We:e,Ge:l}=r.Je();j(l),e.then(g)}else j(t.o);t.hn=null}else a=e.ga,f=j,
(u<2||2===u&&$(t.$)<2?n.getCurTab:n.oe)(d)},l.ne=()=>c&&true!==t.x.confirmed,l.T=(e,n)=>{if(!t.O)return f=null,
t.$=t.$>0?1:-1,Promise.resolve(t.$>0);let u="string"==typeof e?e:"string"==typeof e[0]?e[0]:null
;if(!m&&u)return l.initHelpDialog().then(()=>l.T(e,n));let{We:o,Ge:a}=r.Je(),$=t.$,d=t.x,v=t.O
;return y(setTimeout(_,2e3,0,void 0)),f=e=>{t.Ce=0,t.x=d,t.O=v,t.$=e?$>0?1:-1:$,c=0,a(e),setTimeout(()=>{c=1},0)},
...
})},l.executeShortcut=(e,u)=>{let s=o.ma.get(e),f=38===s.ui&&s.ni;if(f&&t.na(s),y(0),u&&!(512&u.d.s.b)){let t=u.d
;return y(setTimeout(l.executeShortcut,100,e,null)),t.postMessage({N:12,c:e,i:p,m:"",r:false}),512&u.b&&i.Vn(u,0),
void i.ensuredExitAllGrab(u)}let a=o.oi(s),m=f?"runKey":s.ra,$=s.ui,c=0,d=s
;if(s.ni||(18===$?n.we.goBack&&(c=23):11===$&&(c=14)),c)d=o.la(m,a,[c,1,s.fa]);else{if(!s.ni)return;c=s.ui}
...
m&&"object"==typeof m?r.di(m):m=null,$|=0,l.executeCommand(p,c,$,u,0))},l.hasFallbackOptions=e=>!!(e.$then||e.$else),
...
},u=n&&/\$D/.test(n.split("#",1)[0]);y(setTimeout(async()=>{let l=t.a.get(t.ye);await i._i(l,true)
;let r=t.O&&t.O.s.m===t.ye&&l&&l.J.indexOf(t.O)>0?t.O:l?2===l.d.s.f&&l.J.filter(e=>2!==e.s.f&&!(512&e.s.b)).sort((e,l)=>e.s.Q-l.s.Q)[0]||l.d:null
;l&&i.ensuredExitAllGrab(l),t.P(n,r,e)},u?0:r||50))}return u},l.runNextOnTabLoaded=(e,r,u)=>{let i=e.$then
...
},o=false!==r?1500:500,a=!!i&&/[$%]l/.test(i.split("#",1)[0]),m=r?r.id:false!==r?-1:t.ye,$=Date.now()
;y(setInterval(()=>{n.tabsGet(-1!==m?m:t.ye,s)},a?50:100)),i&&/\$D/.test(i.split("#",1)[0])&&n.tabsGet(-1!==m?m:t.ye,s)
...
;return m?Promise.resolve(m):Promise.all([n.import2(t.Z.HelpDialogJS),null!=e[0]?null:r.hi("help_dialog.html"),null!=e[1]?null:s.getI18nJson("help_dialog")]).then(([e,l,r])=>{
