...
}),l.wn=l.openUrlReq=l.openUrl=l.goToNextUrl=l.openUrlWithActions=l.openShowPage=l.openJSUrl=l.parseReuse=l.yn=l.parseOpenPageUrlOptions=l.preferLastWnd=l.newTabIndex=void 0
...
null!=l?l:e.decode),g:e.group,i:e.incognito,k:e.keyword,m:e.replace,o:e.opener,p:e.position,r:e.reuse,s:p.I(e),
t:e.testUrl,w:e.window})
;let c=e=>"boolean"==typeof e?e:e?"force"===e||("reverse"===e?2!==t.de:"same"===e||"keep"===e?2===t.de:null):null,g=e=>"popup"===e||"normal"===e?e:void 0
;l.yn=(e,l)=>{e=e.slice(0,128).split("?")[0].replace(/\\/g,"/")
;let r=t.L>1&&/\/globalroot\/device\/condrv|\bdevice\/condrv\/kernelconnect/.test(e);return r&&(t.O=l||t.O,
o.showHUD(s.K("harmfulURL"))),r};let y=(e,u,f,s)=>{r.Fl();let v=e=>{a.replaceCmdOptions(u),a.overrideCmdOptions({urls:e,
...
;case 4:e>=3&&s[0]&&a.runNextCmdBy(1,u);break;case 6:let p=s[0],m=t.ye;if("openUrls"===p[0]){let l=p.slice(1),t=[]
...
let e=t.a.get(m),l=e?e.d:null,n=r.di({keys:[p[1]]});t.hn=null,"run1"===p[0]?t.P(p[1],l,{c:u.$f,r:u.$retry,u:0,w:0
}):a.executeCommand(d.la("runKey",n),1,0,l,0,null)},0)}},b=(e,l,t)=>{e?a.runNextOnTabLoaded(l,t):a.runNextCmdBy(0,l)
},h=(e,l,r,i,u)=>{let o=l=>(b(l,e,l),n.g());if(u){if(u.length>0&&u[0].incognito&&n.v(r))return void n.tabsCreate({url:r
},o)}else if(n.v(r)&&true!==i)return void n.getCurTab(h.bind(null,e,l,r,true));if(3===l&&t.O&&t.O.s.Q){let l={id:t.O.s.m
...
f.push([s,e,0===t?/^[%$]S|^\$\{S:/.test(i)?u:r.Sl(u):1===t?r.Sl(new URL(u).host):2===t?u&&""+l[0].id:3===t?u&&""+r.Sl(l[0].title):n.t.runtime.id])
...
}):m.eu(g(u.window),true,f,t.xe)).then(e=>e&&new Promise(l=>{n.we.query({active:true,windowId:e.id},t=>(e.tabs=t,l(e),
n.g()))})),o.then(o=>{let s=!!o&&!o.focused&&o.id!==t.xe,d=-7===r&&!s
...
b(e,u,r>-6&&-2!==r&&e)})})},T=(e,r,i,u)=>{
let o=u&&u[0],f=!!o&&o.incognito||2===t.de,s=-2!==r&&-8!==r,d=2===r||r<-3||!!i.window,a=c(i.incognito),v=null!=a&&"string"==typeof i.incognito
;if(!v&&e.some(n.v))d=f||d;else if(f)d=false===a||d;else if(a&&r>-4)return void n.He.getAll(k.bind(null,e,r,i,o))
...
;n.openMultiTabs(m,t.$,v,e,i.group,o,e=>{s&&e&&n.selectWndIfNeed(e),b(e,i,s&&e)})},P=(e,r,i,u,o,s)=>{
let d,v=i?"string"==typeof i?f.kl(i):"object"==typeof i&&i.t&&i.v?i:null:null,p=2===r||1===r,w=1===r||-3===r,y=w&&o.q||{},h=g(w?y.w:u.window),_=c(w?y.i:u.incognito),k=true===(w?y.g:u.group)
;t.$=1,w?(y.m=null,y.g=k):(a.overrideOption("group",k,u),null!=u.replace&&a.overrideOption("replace",v,u)),
d=r<-3&&v?m.eu(h,-7===r,_,t.xe).then(e=>!e||e instanceof Array?null:e):Promise.resolve(!p&&t.xe>=0?{id:t.xe}:null),
Promise.all([d,!k||s?null:new Promise(e=>{n.getCurTab(l=>{s=l||[],e()})})]).then(([e,l])=>v&&(e||p)?new Promise(l=>{
n.we.query(e?{windowId:e.id}:{windowType:h||void 0},e=>{
let i=null!=_?!_:r>-4?2!==t.de:-2,u=(e||[]).filter(e=>f.Ll(v,e.url)&&e.incognito!==i);if(k&&u.length>0&&s.length>0){
let l=n.getGroupId(s[0]);e&&(u=u.filter(e=>n.getGroupId(e)===l))}if(u.sort((e,l)=>{let r=t.De.get(l.id),n=t.De.get(e.id)
...
if(null==i||i.id===t.ye&&!w)w?l.wn(o):a.runNextCmdBy(0,u)||(s?T([e],r,u,s):n.getCurTab(T.bind(null,[e],r,u)));else if(t.In&&i.url.startsWith(t.Z.Ti))x(w?o.f||{}:u,i);else{
...
}))return;if(-1!==u)return void a.runNextCmdBy(0,l);t.O=null}(()=>{let t=r.Xe(e.slice(11));n.ke(n.we.executeScript,{
code:t}).then(e=>{void 0===e&&i&&i(),b(!!e,l,null)}),n.g()})()}},l.openShowPage=(e,r,i,u)=>{let o=t.Z.Ti
...
;e=e.slice(o.length);let f=u?u.incognito:2===t.de
;e.startsWith("#!image ")&&f&&(e="#!image incognito=1&"+e.slice(8).trim());let s=[e,null,0]
;return t.In=s[1]=()=>(clearTimeout(s[2]),t.In=null,s[0]),s[2]=setTimeout(()=>{
s[0]="#!url vimium://error (vimium://show: sorry, the info has expired.)",s[2]=setTimeout(()=>{t.In===s[1]&&(t.In=null),
s[0]="",s[1]=null},2e3)},1200),t.$=1,0===r||3===r||f&&(-2===r||-1===r)?f?n.tabsCreate({url:o,active:-2!==r},e=>{b(e,i,e)
}):x(i,u):(i.incognito=false,1===r||-3===r?P(e,r,i.replace,null,{u:o,a:i.parent,p:i.prefix,
q:l.parseOpenPageUrlOptions(i),f:a.parseFallbackOptions(i)},u?[u]:void 0):T([o],r,i,u?[u]:void 0)),true};let x=(e,l)=>{
let i=t.Z.Ti,u=l.url.split("#",2)[1]?[]:n.t.extension.getViews({tabId:l.id})
...
let r=t.x,u=r.urls;if(2!==r.$fmt){if(1!==r.$fmt)for(let e=0;e<u.length;e++)u[e]=i.Xl(u[e]+"")
;a.overrideCmdOptions({},true),a.overrideOption("urls",u),a.overrideOption("$fmt",2)}
for(let e of u)if(l.yn(e))return n.g();let o=l.parseReuse(r.reuse),f=1===o||0===o||3===o||-3===o?-1:o;t.x=null,
T(u,f,r,e)};l.openUrlWithActions=(e,u,o,f)=>{var s,d;if("string"!=typeof e);else if(e||9!==u){
let n=a.fillOptionWithMask(e,t.x.mask,"value",["url","url_mask","url_mark","value"],t.$),v={};n.ok&&(e=n.result,
n.useCount&&(t.$=1));let m=t.x.url_mask,w=t.x.url_mark;if(null==m&&null==w||(e=I(e,f,null!=m?m:w)),o){let l=p.I(t.x)
;e=t.S(e,0,l,v)}if(9!==u){
let l=null!==(s=v.F)&&void 0!==s?s:(t.x.keyword||"")+"",n=null!==(d=t.x.testUrl)&&void 0!==d?d:!l,o=!!v.F||!!v.Tl||!!l&&"~"!==l
;e=n?i.Xl(e,l,u):i.q(e.trim().split(r.D),l,o?-2:u),e=n||!o?e:i.Xl(e,null,i.zi&&e.startsWith("vimium:")?3:u)}
let c=t.x.goNext;c&&e&&"string"==typeof e&&(e=t.S(e,8192,null,{}),e=l.goToNextUrl(e,t.$,"absolute"===c)[1],
v.F&&(e=i.q(e.trim().split(r.D),v.F,3))),e="string"==typeof e?i.wi(e):e}else e=t.newTabUrl_f
;let v=t.x,m=l.parseReuse(v.reuse)
;t.x=null,r.Fl(),"string"!=typeof e?Promise.resolve(e).then(y.bind(0,u,v,f)):l.openShowPage(e,m,v)||(r.Dl(e)?l.openJSUrl(e,v,null,m):l.yn(e)?a.runNextCmdBy(0,v):1===m||-3===m?P(e,m,v.replace,null,{
u:e,a:v.parent,p:v.prefix,q:l.parseOpenPageUrlOptions(v),f:a.parseFallbackOptions(v)
},f):0===m||3===m?h(v,m,e):v.replace?P(e,m,v.replace,v,null,f):f?T([e],m,v,f):n.getCurTab(T.bind(null,[e],m,v)))}
...
let e=t.x.testUrl;(null!=e?e:!t.x.keyword)&&(d=u.Tn(d,e))}let m=d.indexOf("://")+3;if(m>3&&r.ln.test(d)){
...
;n?(r=r.includes("<")?r.split("<")[0]:r.split(">")[1],l=t.vl.get(n)||"",l=t.S(l,32768,p.I(t.x),i)):l=t.Jl(p.I(t.x),0,i),
null!=i.F&&a.overrideCmdOptions({keyword:i.F}),l instanceof Promise?l.then(U.bind(null,r,e)):U(r,e,l)
}else l.openUrlWithActions(t.x.url_f||"",9,false,e)},l.openUrlReq=(e,n)=>{var f,s;r.di(e)
...
;v=g?u.Pn(v,_):v,v=t.S(v,o,y,n);let f,a=null!==(s=n.F)&&void 0!==s?s:w
;_?v=(f=v!==l)?i.Xl(v,null,-1):v:(f=!!g||!d&&!a)?(v=g?u.Tn(v,g):v,
v=i.Xl(v,a,d?-1:3)):(v=i.q(v.trim().split(r.D),a,a&&"~"!==a?-1:0),
f=i.zi,v=f?i.Xl(v,null,v.startsWith("vimium:")?3:0):v),
f&&(2!==i.Yl&&1!==i.Yl||null==e.h?3===i.Yl&&v.startsWith("vimium:")&&!l.startsWith("vimium://")&&(v=i.Xl(v,null,i.zi||v.startsWith("vimium://run")?3:0)):v=(e.h?"https":"http")+v.slice("s"===v[4]?5:4)),
p.opener=d?false!==m.o:t.pi.actions.includes("opener"),p.url_f=v}else{if(!e.c)return t.O=n||o.findCPort(null),
void(a.runNextCmdBy(0,p)||o.showHUD("",14));p.copied=e.c,p.keyword=w,p.testUrl=m.t,p.sed=y}t.$=1,a.replaceCmdOptions(p),
l.openUrl()},l.wn=(e,u)=>{let o,f=r=>{var i;let f=null!==(i=c(w.i))&&void 0!==i?i:2===t.de&&null;if(r=r||[],
null!==f&&(r=r.filter(e=>e.incognito===f)),w.g&&o.length>0){let e=n.getGroupId(o[0]);r=r.filter(l=>n.getGroupId(l)===e)}
if(r.length>0){let e=r.filter(e=>e.windowId===t.xe);return void s(e.length>0?e:r)}let v=2===t.de&&n.v(e.u)
;return e.f&&a.runNextCmdBy(0,e.f)||(o.length<=0||w.w||2===y?n.makeWindow({url:e.u,type:g(w.w),incognito:!v&&2===t.de
...
!r.startsWith(t.Z.Fr)||t.a.get(o.id)||e.s)if(t.In&&o.url.startsWith(t.Z.Ti))x(e.f||{},o),n.selectWndIfNeed(o);else{
...
}else n.tabsCreate({url:r},d),n.we.remove(o.id)},d=l=>{if(!l)return e.f&&a.runNextCmdBy(0,e.f),n.g()
;a.runNextOnTabLoaded(e.f||{},l,e.s&&(()=>{v.be.xn(e,l.id,0,p)}))},p=false,m=i.wi(e.u.split("#",1)[0])
;if(l.yn(m,u))return;let w=e.q||(e.q={});(null==w.g||m.startsWith(t.Z.Fr))&&(w.g=false)
;let y=null!=w.r?l.parseReuse(w.r):1;w.m?P(e.u,3!==y&&0!==y?y:1,w.m,null,e):n.ke(n.getCurTab).then(async l=>{o=l
;let i=[],u=-3===y&&t.xe>=0?t.xe:void 0,s=m,d=g(w.w)||"normal";if(r.ln.test(m)){
...
i.push(a?s+"*":s);for(let l of i){let r=await n.ke(n.we.query,{url:l,windowType:d,windowId:u})
