...
}),t.vi=t.gi=t.ia=t.sa=t.oi=t.la=t.ca=t.ua=t.z=t.si=t.ma=t.da=t.pa=void 0
;let s,l,c,u=n.tryParse,m=/<(?!<)(?:.-){0,4}.\w*?(?::i)?>|./g;t.pa=m,t.ma=l,t.da=c;let d,p=true,b=null;t.si=b,
...
};t.ca=(e,a)=>{let n,r=e.ba;if(void 0===a&&(a=t.ia[e.ra]),n=a.length<4?null:o.di(a[3]),"string"==typeof r&&(r=t.ua(r)),
r){
...
delete r.count),r.$if){if(false===T(r))return false;delete r.$if}if(n&&o.bi(r,n),2===a[0]&&!a[1]){
let t=r,a=t.mode,n=t.m,s=t.characters,l=t.action,c=t.button,u=s&&"string"==typeof s?o.va(i.W("c",s)):null
;if(u&&u.length<4)return e.ui=41,e.ni=1,e.ba=o.di({text:"Too few characters for LinkHints",isError:true}),e.fa=1,true
...
void 0!==t.xy&&(t.xy=o.G(t.xy)),(t.direct||t.target)&&(t.direct=t.direct||t.target,
t.directOptions=t.directOptions||t.targetOptions,delete t.target,delete t.targetOptions,a&=-17),a!==n&&(t.m=a),
a>63&&(e.fa=1)}}else r=n;return e.ba=r,true},t.la=(e,a,n)=>{void 0===n&&(n=t.ia[e]);let i={ui:n[0],ni:n[1],ra:e,
ba:a||(n.length<4?null:o.di(n[3])),ga:null,fa:n[2]};return a&&"object"==typeof a&&!t.ca(i,n)?null:i},t.oi=e=>{let a=e.ba
...
t&&"object"==typeof t?t.sys&&t.sys!==a.Z.ka||t.browser&&!(1&t.browser)||t.before&&t.before.replace("v","")<a.Z.Ta?o:!o:null
};t.sa=(e,t)=>{let a=true,n=0,i=t;if(e[t].startsWith("#if")){
let n=e[t].slice(4).trim(),i=n.startsWith("{")?u(n):n.split(/#|\/\//)[0];a=i&&false===T(o.di({$if:i}))}
...
C||(c?!(l.startsWith("userCustomized")&&l.length>14)&&a.Z.wa.indexOf(l)<0?x('Shortcut %c"%s"',F,l,"is not a valid name"):_.has(l)&&!k(e,p-1-c.length)?x('Shortcut %c"%s"',F,l,"has been configured"):N=true:x("Lack command name and options in shortcut:",e)),
...
for(let e of a.Z.wa)e.startsWith("user")||_.has(e)||(g=t.la(e,null))&&_.set(e,g);if(0!==I)for(s=M.size,
I||(I=$.split(" ")),r=I.length,H=0;H<r;H+=2)M.has(I[H])||M.set(I[H],t.la(I[H+1],null));a.ii=M,t.ma=l=_,t.da=c=U,
...
;i&&(a.pn=t.si=b=null,y(e));let c,u=o.en(a.ii),v=i&&p;i&&(a.ha=(a.ya?L(a.ya):0)|(u.join().includes(":i>")?64:0))
;for(let e=0;e<u.length;e++){let o=u[e],i=o.match(m),r=i.length-1,l=t.z(i[0]),d=n.get(l)
;if(e>=s&&void 0!==d&&(1===d||0===r||"object"==typeof d[i[1]])){a.ii.delete(o);continue}if(0===r){void 0!==d&&v&&M(o,d),
...
(b||(t.si=b=[])).push([].slice.call(arguments,0))
...
;t.gi=["character","word","","lineboundary","line","sentence","paragraphboundary","paragraph","documentboundary"],t.vi={
...
"c-y":61,"c-down":62,"c-up":61};let U=e=>{let t="";if(!b&&p&&(t="#!no-check\n"),t){let o=a.fl.keyMappings
;a.fl.keyMappings=void 0;try{i.La("keyMappings",t+e)}catch(e){}a.fl.keyMappings=o}};2&a.el&&(H(a.A.keyMappings),
a.L||(t.vi["m-s-c"]=36)),a.fl.keyMappings=e=>{let t=a.ya,o=a.pn;H(e)
