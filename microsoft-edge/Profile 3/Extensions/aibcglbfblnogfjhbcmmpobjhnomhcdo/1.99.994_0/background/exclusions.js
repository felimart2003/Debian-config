...
Object.defineProperty(l,"__esModule",{value:true}),l.in=l.un=l.rs=l.on=l.fn=l.ss=l.Ll=l.kl=l.sn=void 0,l.sn=(e,l)=>{
let t,r,u
;return l=l&&l.replace(/<(\S+)>/g,"$1"),"^"===e[0]?(t=n.pl(e.startsWith("^$|")?e.slice(3):e,"",0))||console.log("Failed in creating an RegExp from %o",e):"`"===e[0]&&((r=n.an(e.slice(1),0))||console.log("Failed in creating an URLPattern from %o",e)),
u=t?{t:1,v:t,k:l}:r?{t:3,v:{p:r,s:e.slice(1)},k:l}:{t:2,
v:e.startsWith(":vimium://")?i.vn(e.slice(10),false,-1):e.slice(1),k:l},u},l.kl=e=>{let l;if("^"===e[0]){
...
},l.Ll=(e,l)=>1===e.t?e.v.test(l):2===e.t?l.startsWith(e.v):e.v.p.test(l);let f=false;l.ss=f;let s=false;l.fn=s
...
;if(null!=e)return l.rs(e.s.Rl,e.s)}return u?u.trim():null};let d=()=>{let e=!r.N()||false?null:e=>{t.dn[10](e)}
...
;for(let t of e.J){let r=null,i=0;if(n){if(0===t.s.f)continue}else if(r=l.rs(t.s.Rl,t.s),i=null===r?0:r?1:2,
...
;let e=r.N().onReferenceFragmentUpdated;i?e.addListener(n):e.removeListener(n)}};t.fl.exclusionRules=e=>{
let n=!v.length,r=t.pn;c(e),a=t.A.exclusionOnlyFirstMatch,m(),setTimeout(()=>{setTimeout(l.in,10,n),
t.pn===r&&u._l("keyMappings",null)},1)},t.fl.exclusionOnlyFirstMatch=e=>{a=e},t.fl.exclusionListenHash=m,u.sl.then(()=>{
