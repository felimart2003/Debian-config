...
}),l.eu=l.lu=l.re=l.tu=l.mayRequireActiveTab=l.getNecessaryCurTabInfo=l._e=l.getNearArrIndex=l.ru=l.Ke=l.Me=l.getTabRange=void 0,
...
};l.Me=(e,r,n,a,s,c)=>{let o=a=>{if(!a||!a.length)return s(0),u.g()
...
;if(a)if(0===a.length||Math.abs(t.$)>1||f)if(0===a.length||f||false){let e=a[0]?a[0].windowId:t.xe
;(e>=0?u.ke(u.He.get,e,{populate:true}):u.ke(u.getCurWnd,true)).then(e=>{o(e?e.tabs:[])})
}else o(a);else r?a[0].index+t.$<0?u.oe(o):u.we.query({windowId:a[0].windowId,index:a[0].index+t.$
},r=>(r&&r.length&&(true===c||u.$e(r[0])&&(!c||c(r[0])))&&(!d||l.re(a[0],r,d).length>0)?t.$<0?n([r[0],a[0]],[0,1,e?2:1],s):n([a[0],r[0]],[e?0:1,0,2],s):u.oe(o),
u.g())):n(a,[0,0,1],s);else s(0)},l.Ke=()=>{let e=0,l=-1;return t.De.forEach((r,u)=>{r>e&&u!==t.ye&&(e=r,l=u)}),l},
l.ru=(e,t,r)=>{let n
;return e&&(e.index||t)?r&&r[n=Math.max(r.indexOf(e),0)+(t?1:-1)]&&u.$e(r[n])?Promise.resolve(r[n]):u.ke(u.we.query,{
windowId:e.windowId,index:e.index+(t?1:-1)
}).then(n=>n&&n[0]?u.$e(n[0])?n[0]:(r&&r.length>2?Promise.resolve(r.filter(u.$e)):u.ke(u.oe)).then(r=>r&&r.length?r[l.getNearArrIndex(r,e.index+(t?1:-1),t)]:null):null):Promise.resolve(null)
...
l._e=(e,l)=>{1===Math.abs(e)?u.getCurTab(t=>{let r=t[0].index+e;r>=0?u.we.query({windowId:t[0].windowId,index:r
...
;return t>2?u.ke(u.getCurTab).then(e=>e&&e[0]||null):t?Promise.resolve(n.j(null,t>1)).then(e=>e?{url:e}:null):null},
...
;return u?e=>u.test(e||""):l?e=>(e||"").includes(l):null};l.re=(e,l,i,d)=>{var f;let h=0,m=0,b=0,w=[]
;for(let l of(i+"").split(/[&+]/)){
let n=l.split("=",1)[0],i=n.includes("."),s=!i&&n.endsWith("!"),d=i?"":(s?n.slice(0,-1):n)||l,k=l.slice(i?0:n.length+("="===l.charAt(n.length+1)?2:1)),v=k&&r.Xe(k),g="same"===v||"cur"===v||"current"===v,p=null
;switch(d){case"title":case"title*":let l=o(v,v||e&&e.title);p=l?e=>l(e.title):null;break;case"url":case"urlhash":
case"url+hash":case"url-hash":case"hash":let n=null;if("url"===d&&v)n=a.kl(v);else{
let l=e?u.getTabUrl(e):null,t=d.includes("hash");n=l?a.kl(":"+(t?l:l.split("#",1)[0])):null}
p=n?e=>a.Ll(n,u.getTabUrl(e)):p;break;case"title+url":let i=v&&o(v,v);p=i?e=>i(e.title)||i(u.getTabUrl(e)):p;break
...
;p=null!=w?e=>e.active===w:p;break;case"new":case"old":case"visited":let k=c(v)===("new"!==d);p=e=>t.De.has(e.id)===k
...
;return(null!==(l=u.getGroupId(e))&&void 0!==l?l:"")+""===M}:p;break;case"hidden":let _=null;p=null!=_?e=>u.$e(e)!==_:p
...
[];if(h){let l=e?k.indexOf(e):-1;if(l<0){let r=e?e.id:t.ye;l=k.findIndex(e=>e.id===r)}if(l>=0){
...
let l=e.tab.id,r=t.De.get(l);e.time=l===t.ye?1:null!=r?r:l+2
...
let e=await u.ke(u.He.get,t.nu);if(e&&i(e))return e;t.nu=-1}let s=[];{let e=(await u.ke(u.getCurTabs)||[]).map(e=>e.id)
;e.push(t.ye),t.De.forEach((l,t)=>{e.includes(t)||s.push([t,l])}),s.sort((e,l)=>l[1]-e[1])}if(s.length>0){
let e=await u.Ne(u.we.get,s[0][0]);if(!e){let l=s.find(e=>t.a.has(e[0]));e=l&&await u.Ne(u.we.get,l[0])}
let l=e&&await u.Ne(u.He.get,e.windowId);if(l&&i(l))return l}
let c=await u.Ne(u.He.getAll),o=c.filter(i),d=o.filter(e=>e.id!==n);return d.sort((e,l)=>l.id-e.id),
