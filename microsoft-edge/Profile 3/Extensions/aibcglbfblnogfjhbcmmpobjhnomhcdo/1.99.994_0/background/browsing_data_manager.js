...
e.onImportEnded.addListener(()=>{r.t.bookmarks.onCreated.addListener(t.ot.Tt),t.ot.Tt()})},gt(){l.ue.f=1,
t.ot.ct&&(clearTimeout(t.ot.ct),t.ot.ct=0),r.t.bookmarks.getTree(t.ot.xt)},xt(e){l.ue.ie=[],l.ue.Ve=[],l.ue.f=2,
n.vt.ve(2),e.forEach(t.ot.kt),setTimeout(()=>t.et.yt(l.ue.ie),50),t.ot.ht&&(setTimeout(t.ot.ht,0),t.ot.ht=null)
;let r=t.ot.pt;t.ot.pt=null,r&&r()},kt(e,r){let o=e.title,n=e.id,f=o||n,u=t.ot._t+"/"+f;if(e.children){l.ue.Ve.push({
te:n,Dt:u,wt:f});let r=t.ot._t,i=t.ot.at;2<++t.ot.mt&&(t.ot._t=u),t.ot.at=n,e.children.forEach(t.ot.kt),--t.ot.mt,
t.ot._t=r,t.ot.at=i}else{let s=e.url,_="javascript:",a=s.startsWith(_);l.ue.ie.push({te:n,Dt:u,wt:f,t:a?_:s,
Pt:c?t.lt(s,p?u:o):1,u:a?_:s,ee:t.ot.at,le:r,Ee:a?s:null,Rt:a?i.Xe(s):null})}},Tt(){let e=()=>{
let r=performance.now()-l.ue.Be;0===l.ue.f&&(r>=59900||r<-5e3?(t.ot.ct=t.ot.dt=0,t.ot.gt()):t.ot.ct=setTimeout(e,3e4))}
;l.ue.Be=performance.now(),l.ue.f<2||(t.ot.ct=setTimeout(e,6e4),l.ue.f=0)},bt(e,r){
let i=l.ue.ie,o=r&&r.title,n=i.findIndex(t=>t.te===e);if(n>=0){let e=i[n],u=e.u,s=r&&r.url
;if(f&&(null==o?u!==e.t||!r:null!=s&&u!==s)&&l.It.has(u)&&t.it.Lt&&t.it.Ut(u)<0&&l.It.delete(u),
null!=o)e.Dt=e.Dt.slice(0,-e.wt.length)+(o||e.te),e.wt=o||e.te,s&&(e.u=s,e.t=t.et.Mt(s,e),t.et.jt()),
c&&(e.Pt=t.lt(e.Ee||e.u,p?e.Dt:e.wt)),l.ue.Be=performance.now();else{i.splice(n,1)
;for(let t=r?n:i.length;t<i.length;t++)i[t].ee===e.ee&&i[t].le--;r||t.ot.Tt()}}else if(l.ue.Ve.find(t=>t.te===e)){
if(null==o&&!t.ot.dt&&f){let e=l.It,r=t.it.Ut;for(let{u:l}of t.it.Lt?i:[])e.has(l)&&r(l)<0&&e.delete(l);t.ot.dt=1}
t.ot.Tt()}}},l.Y=(e,r)=>{if(2!==l.ue.f){let o=i.Je();return t.ot.pt=o.Ge,t.ot.gt(),o.We.then(l.Y.bind(0,e,r))}
let o=!r&&e.includes("/"),n=o?(e+"").replace(/\\\/?|\//g,e=>e.length>1?"/":"\n").split("\n").filter(e=>e):[]
;if(!e||o&&!n.length)return Promise.resolve(false)
;if(r)return Promise.resolve(l.ue.ie.find(t=>t.te===e)||l.ue.Ve.find(t=>t.te===e)||null)
;let f=o?"/"+n.slice(1).join("/"):"",u=o?"/"+n[0]+f:""
;for(let t of l.ue.ie)if(o&&(t.Dt===u||t.Dt===f)||t.wt===e)return Promise.resolve(t)
;for(let t of l.ue.Ve)if(o&&(t.Dt===u||t.Dt===f)||t.wt===e)return Promise.resolve(t);let s=null
;for(let t of l.ue.ie)if(t.wt.includes(e)){if(s){s=null;break}s=t}return Promise.resolve(s)};let h=e=>{e&&e()};t.it={
...
Qt:8===e.ut?1:0}))}if(s>=0){if(a.qt=i,o&&o!==a.wt&&(a.wt=o,n.vt.Xt&&n.vt.ve(1),c)){let e=t.lt(r,o);a.Pt!==e&&(a.Pt=e,
_&&(_.Nt+=e||-1))}}else a.t=t.et.Mt(r,a),l.St.Ct.splice(~s,0,a),n.vt.Xt&&n.vt.ve(1)},$t(e){u.length=0;let r=l.It
;if(n.vt.ve(1),e.allHistory){l.St.Ct=[],l.St.Gt=new Map;let e=[];for(let t of l.ue.ie){let l=r.get(t.u)
...
;let n=i(e);if(n<0)l.St.Jt--;else{let e=o.title;if(!e||e===r[n].wt)continue}l.St.Ft--,t.it.zt(o)}},Ut(e){
let t="",r=l.St.Ct,i=r.length-1,o=0,n=0;for(;o<=i;)if(n=o+i>>>1,t=r[n].u,t>e)i=n-1;else{if(t===e)return n;o=n+1}return~o
}},t.rt=(e,i,o)=>{let n=r.Pe();n?n.getRecentlyClosed({
...
;if(!i&&!t.lt(_,a))continue;n=r.lastModified,n=n<3e11&&n>-4e10?1e3*n:n;let m=e.windowId;f.push({u:_,wt:a,tl:n,
rl:[m,(o||e).sessionId,o?o.tabs.length:0],il:o?` +${o.tabs.length>1?o.tabs.length-1:""}`:m&&m!==l.xe&&n>s?" +":""})}
return u?setTimeout(o,0,f):o(f),r.g()}):o([])},t.lt=(e,t)=>d.test(t)||d.test(e)?0:1,t.tt={ol(e){
...
if(l.ue.ie)for(let e of l.ue.ie)e.Pt=c?t.lt(e.Ee||e.u,p?e.Dt:e.wt):1;if(!l.St.Ct)return;let e=l.St.Gt
...
(l.St.Ct||l.ue.ie.length)&&setTimeout(t.tt.nl,100)},o.sl.then(()=>{o._l("omniBlockList")}),l.fl.localeEncoding=e=>{
let r=!!e&&!(e=e.toLowerCase()).startsWith("utf"),i=a;if(a=r?e:"",a!==i){try{new TextDecoder(a)}catch(e){r=false}
r?"1"!==i&&setTimeout(()=>(l.St.Ct&&t.et.yt(l.St.Ct),t.et.yt(l.ue.ie)),100):(l.It.clear(),u&&(u.length=0)),
f!==r&&(u=r?[]:{length:0,push:l.o},f=r,_=-1)}},o._l("localeEncoding"),l.ml.al=(e,l,i)=>{switch(l){case"tab":
n.vt.cl(null),r.we.remove(+e,()=>{let e=r.g();return e||n.vt.cl(null),i(!e),e});break;case"history":
let l=!t.it.Lt||t.it.Ut(e)>=0;r.t.history.deleteUrl({url:e}),l&&n.vt.ve(1),i(l)}},l.ml.dl=t.tt.ol});