...
a,!0);b.onload=function(){var d=null;200===this.status&&(d=b.response);return c(d)};b.send()},Y=function(){500>Math.floor(1E3*Math.random())&&(E=!0);var a=window.localStorage.options,c={};a&&(c=JSON.parse(a));z=ha(c);window.localStorage.options=JSON.stringify(z);chrome.storage.local.get("word-history",function(b){b["word-history"]||chrome.storage.local.set({"word-history":{}})});chrome.runtime.onMessage.addListener(aa);chrome.runtime.onMessage.addListener(ba);chrome.runtime.onMessage.addListener(ca);
